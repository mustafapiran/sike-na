...
exports.run = async (client, message, args) => {
...

 {
  ...
  if(!isimler) {
          ...
          .setDescription("<a:text8:856487156826243104> <@"+member+"> üyesi başarıyla kız olarak kayıt edildi.")
          .setColor("RANDOM")
